...
* Authors: Colin Tapp / Henry Forget
************************************************************
 ...
 * -------------------------------------------------------------
 */
mouse_None bErrorPrint(mouse_str fmt, ...);
mouse_None displayBuffer(Buffer* ptr_Buffer);
mouse_long getFileSize(mouse_str fname);
mouse_int isNumber(const mouse_str ns);
mouse_None startReader(mouse_str, mouse_str, mouse_char, mouse_int, mouse_int);
...
mouse_int mainReader(mouse_int argc, mouse_str* argv) {
	...
	mouse_str program = argv[0];
	mouse_str input = argv[2];
	mouse_char mode = MODE_FIXED;
	mouse_int size = 0, increment = 0, wrongNumber = 0;
...
************************************************************
*/
mouse_None startReader(mouse_str program, mouse_str input, mouse_char mode, mouse_int size, mouse_int increment) {
